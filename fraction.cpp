...
{
	double c(num/denum), d((b.num/b.denum));
	return c >= d;
}
...
{
	double c(a.get_num()/a.get_denum()), d((b.get_num()/b.get_denum()));
	return c > d;
}
...
{
	double c(a.get_num()/a.get_denum()), d((double)b);
	return c > d;
}
...
{
	double c(a.get_num()/a.get_denum());
	return c > b;
}
